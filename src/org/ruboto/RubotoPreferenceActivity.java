...
public class RubotoPreferenceActivity extends android.preference.PreferenceActivity {
  ...
  public static final int CB_LIST_ITEM_CLICK = 1;
  public static final int CB_ACTIVITY_RESULT = 2;
  public static final int CB_CHILD_TITLE_CHANGED = 3;
  public static final int CB_CONFIGURATION_CHANGED = 4;
  public static final int CB_CONTENT_CHANGED = 5;
  public static final int CB_CONTEXT_ITEM_SELECTED = 6;
  public static final int CB_CONTEXT_MENU_CLOSED = 7;
  public static final int CB_CREATE_CONTEXT_MENU = 8;
  ...
  public static final int CB_KEY_UP = 19;
  public static final int CB_LOW_MEMORY = 20;
  public static final int CB_MENU_ITEM_SELECTED = 21;
  public static final int CB_MENU_OPENED = 22;
  public static final int CB_NEW_INTENT = 23;
  public static final int CB_OPTIONS_ITEM_SELECTED = 24;
  public static final int CB_OPTIONS_MENU_CLOSED = 25;
  public static final int CB_PANEL_CLOSED = 26;
  public static final int CB_PAUSE = 27;
  public static final int CB_POST_CREATE = 28;
  public static final int CB_POST_RESUME = 29;
  public static final int CB_PREPARE_DIALOG = 30;
  public static final int CB_PREPARE_OPTIONS_MENU = 31;
  public static final int CB_PREPARE_PANEL = 32;
  public static final int CB_RESTART = 33;
  public static final int CB_RESTORE_INSTANCE_STATE = 34;
  public static final int CB_RESUME = 35;
  public static final int CB_RETAIN_NON_CONFIGURATION_INSTANCE = 36;
  public static final int CB_SAVE_INSTANCE_STATE = 37;
  public static final int CB_SEARCH_REQUESTED = 38;
  public static final int CB_START = 39;
  public static final int CB_STOP = 40;
  public static final int CB_TITLE_CHANGED = 41;
  public static final int CB_TOUCH_EVENT = 42;
  public static final int CB_TRACKBALL_EVENT = 43;
  public static final int CB_WINDOW_ATTRIBUTES_CHANGED = 44;
  public static final int CB_WINDOW_FOCUS_CHANGED = 45;
  public static final int CB_USER_INTERACTION = 46;
  public static final int CB_USER_LEAVE_HINT = 47;
  public static final int CB_ATTACHED_TO_WINDOW = 48;
  public static final int CB_DETACHED_FROM_WINDOW = 49;
  public static final int CB_KEY_LONG_PRESS = 50;
  public static final int CB_APPLY_THEME_RESOURCE = 51;
  private IRubyObject[] callbackProcs = new IRubyObject[54];
  ...
  public boolean onPreferenceTreeClick(android.preference.PreferenceScreen preferenceScreen, android.preference.Preference preference) {
    if (callbackProcs[CB_PREFERENCE_TREE_CLICK] != null) {
      ...
      try {
        return (Boolean)RuntimeHelpers.invoke(getRuby().getCurrentContext(), callbackProcs[CB_PREFERENCE_TREE_CLICK], "call" , JavaUtil.convertJavaToRuby(getRuby(), preferenceScreen), JavaUtil.convertJavaToRuby(getRuby(), preference)).toJava(boolean.class);
  ...
  public void onListItemClick(android.widget.ListView l, android.view.View v, int position, long id) {
    if (callbackProcs[CB_LIST_ITEM_CLICK] != null) {
      super.onListItemClick(l, v, position, id);
      try {
        IRubyObject[] args = {JavaUtil.convertJavaToRuby(getRuby(), l), JavaUtil.convertJavaToRuby(getRuby(), v), JavaUtil.convertJavaToRuby(getRuby(), position), JavaUtil.convertJavaToRuby(getRuby(), id)};
        RuntimeHelpers.invoke(getRuby().getCurrentContext(), callbackProcs[CB_LIST_ITEM_CLICK], "call" , args);
      } catch (RaiseException re) {
        re.printStackTrace();
      }
    } else {
