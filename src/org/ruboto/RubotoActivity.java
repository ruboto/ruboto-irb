...
public class RubotoActivity extends android.app.Activity implements org.ruboto.RubotoComponent {
  ...
  public static final int CB_ACTION_MODE_FINISHED = 50;
  public static final int CB_ACTION_MODE_STARTED = 51;
  public static final int CB_ATTACH_FRAGMENT = 52;
  public static final int CB_KEY_SHORTCUT = 53;
  public static final int CB_WINDOW_STARTING_ACTION_MODE = 54;
  public static final int CB_GENERIC_MOTION_EVENT = 55;
  public static final int CB_APPLY_THEME_RESOURCE = 56;

    private final ScriptInfo scriptInfo = new ScriptInfo(60);
  ...
  public android.app.Dialog onCreateDialog(int id) {
    ...
    if (JRubyAdapter.isInitialized()) {
      if (scriptInfo.getCallbackProcs() != null && scriptInfo.getCallbackProcs()[CB_CREATE_DIALOG] != null) {
        ...
        return (android.app.Dialog) JRubyAdapter.runRubyMethod(android.app.Dialog.class, scriptInfo.getCallbackProcs()[CB_CREATE_DIALOG], "call" , id);
      } else {
        String rubyClassName = scriptInfo.getRubyClassName();
  ...
  public void onPrepareDialog(int id, android.app.Dialog dialog) {
    ...
    if (JRubyAdapter.isInitialized()) {
      if (scriptInfo.getCallbackProcs() != null && scriptInfo.getCallbackProcs()[CB_PREPARE_DIALOG] != null) {
        ...
        JRubyAdapter.runRubyMethod(scriptInfo.getCallbackProcs()[CB_PREPARE_DIALOG], "call" , new Object[]{id, dialog});
      } else {
        String rubyClassName = scriptInfo.getRubyClassName();
  ...
  public void onActionModeFinished(android.view.ActionMode mode) {
    if (ScriptLoader.isCalledFromJRuby()) { return;}
    if (JRubyAdapter.isInitialized()) {
      if (scriptInfo.getCallbackProcs() != null && scriptInfo.getCallbackProcs()[CB_ACTION_MODE_FINISHED] != null) {
        JRubyAdapter.runRubyMethod(scriptInfo.getCallbackProcs()[CB_ACTION_MODE_FINISHED], "call" , mode);
      } else {
        String rubyClassName = scriptInfo.getRubyClassName();
  ...
  public void onActionModeStarted(android.view.ActionMode mode) {
    if (ScriptLoader.isCalledFromJRuby()) { return;}
    if (JRubyAdapter.isInitialized()) {
      if (scriptInfo.getCallbackProcs() != null && scriptInfo.getCallbackProcs()[CB_ACTION_MODE_STARTED] != null) {
        JRubyAdapter.runRubyMethod(scriptInfo.getCallbackProcs()[CB_ACTION_MODE_STARTED], "call" , mode);
      } else {
        String rubyClassName = scriptInfo.getRubyClassName();
  ...
  public void onAttachFragment(android.app.Fragment fragment) {
    if (ScriptLoader.isCalledFromJRuby()) { return;}
    if (JRubyAdapter.isInitialized()) {
      if (scriptInfo.getCallbackProcs() != null && scriptInfo.getCallbackProcs()[CB_ATTACH_FRAGMENT] != null) {
        JRubyAdapter.runRubyMethod(scriptInfo.getCallbackProcs()[CB_ATTACH_FRAGMENT], "call" , fragment);
      } else {
        String rubyClassName = scriptInfo.getRubyClassName();
  ...
  public android.view.View onCreateView(android.view.View parent, java.lang.String name, android.content.Context context, android.util.AttributeSet attrs) {
    ...
    if (JRubyAdapter.isInitialized()) {
      if (scriptInfo.getCallbackProcs() != null && scriptInfo.getCallbackProcs()[CB_CREATE_VIEW] != null) {
        return (android.view.View) JRubyAdapter.runRubyMethod(android.view.View.class, scriptInfo.getCallbackProcs()[CB_CREATE_VIEW], "call" , new Object[]{parent, name, context, attrs});
      } else {
        String rubyClassName = scriptInfo.getRubyClassName();
        if ((Boolean)JRubyAdapter.runScriptlet("defined?(" + rubyClassName + ") == 'constant' && " + rubyClassName + ".instance_methods(false).any?{|m| m.to_sym == :on_create_view}")) {
          // FIXME(uwe): Simplify when we stop support for RubotoCore 0.4.7
  ...
  public boolean onKeyShortcut(int keyCode, android.view.KeyEvent event) {
    ...
    if (JRubyAdapter.isInitialized()) {
      if (scriptInfo.getCallbackProcs() != null && scriptInfo.getCallbackProcs()[CB_KEY_SHORTCUT] != null) {
        return (Boolean) JRubyAdapter.runRubyMethod(Boolean.class, scriptInfo.getCallbackProcs()[CB_KEY_SHORTCUT], "call" , new Object[]{keyCode, event});
      } else {
        String rubyClassName = scriptInfo.getRubyClassName();
  ...
  public android.view.ActionMode onWindowStartingActionMode(android.view.ActionMode.Callback callback) {
    if (ScriptLoader.isCalledFromJRuby()) return null;
    if (JRubyAdapter.isInitialized()) {
      if (scriptInfo.getCallbackProcs() != null && scriptInfo.getCallbackProcs()[CB_WINDOW_STARTING_ACTION_MODE] != null) {
        return (android.view.ActionMode) JRubyAdapter.runRubyMethod(android.view.ActionMode.class, scriptInfo.getCallbackProcs()[CB_WINDOW_STARTING_ACTION_MODE], "call" , callback);
      } else {
        String rubyClassName = scriptInfo.getRubyClassName();
  ...
  public boolean onGenericMotionEvent(android.view.MotionEvent event) {
    if (ScriptLoader.isCalledFromJRuby()) return false;
    if (JRubyAdapter.isInitialized()) {
      if (scriptInfo.getCallbackProcs() != null && scriptInfo.getCallbackProcs()[CB_GENERIC_MOTION_EVENT] != null) {
        return (Boolean) JRubyAdapter.runRubyMethod(Boolean.class, scriptInfo.getCallbackProcs()[CB_GENERIC_MOTION_EVENT], "call" , event);
      } else {
        String rubyClassName = scriptInfo.getRubyClassName();
