...
public class RubotoButton extends android.widget.Button {
  ...
  public  RubotoButton(android.content.Context context) {
    super(context);
  }

  public  RubotoButton(android.content.Context context, android.util.AttributeSet attrs) {
    super(context, attrs);
  }

  public  RubotoButton(android.content.Context context, android.util.AttributeSet attrs, int defStyle) {
