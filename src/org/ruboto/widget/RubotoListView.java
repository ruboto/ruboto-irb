...
public class RubotoListView extends android.widget.ListView {
  ...
  public static final int CB_CONFIGURATION_CHANGED = 36;
  public static final int CB_DISPLAY_HINT = 37;
  public static final int CB_VISIBILITY_CHANGED = 38;
  private IRubyObject[] callbackProcs = new IRubyObject[39];
  ...
  public void onFilterComplete(int count) {
    if (callbackProcs[CB_FILTER_COMPLETE] != null) {
      ...
      try {
        RuntimeHelpers.invoke(getRuby().getCurrentContext(), callbackProcs[CB_FILTER_COMPLETE], "call" , JavaUtil.convertJavaToRuby(getRuby(), count));
  ...
  public void onGlobalLayout() {
    if (callbackProcs[CB_GLOBAL_LAYOUT] != null) {
      ...
      try {
        RuntimeHelpers.invoke(getRuby().getCurrentContext(), callbackProcs[CB_GLOBAL_LAYOUT], "call" );
      } catch (RaiseException re) {
        re.printStackTrace();
      }
    } else {
  ...
  public void onTextChanged(java.lang.CharSequence s, int start, int before, int count) {
    if (callbackProcs[CB_TEXT_CHANGED] != null) {
      ...
      try {
        IRubyObject[] args = {JavaUtil.convertJavaToRuby(getRuby(), s), JavaUtil.convertJavaToRuby(getRuby(), start), JavaUtil.convertJavaToRuby(getRuby(), before), JavaUtil.convertJavaToRuby(getRuby(), count)};
  ...
  public void onTouchModeChanged(boolean isInTouchMode) {
    if (callbackProcs[CB_TOUCH_MODE_CHANGED] != null) {
      ...
      try {
        RuntimeHelpers.invoke(getRuby().getCurrentContext(), callbackProcs[CB_TOUCH_MODE_CHANGED], "call" , JavaUtil.convertJavaToRuby(getRuby(), isInTouchMode));
      } catch (RaiseException re) {
        re.printStackTrace();
      }
    } else {
