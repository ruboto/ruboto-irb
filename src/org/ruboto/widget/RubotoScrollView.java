...
public class RubotoScrollView extends android.widget.ScrollView {
  ...
  public static final int CB_LAYOUT = 0;
  public static final int CB_INTERCEPT_TOUCH_EVENT = 1;
  public static final int CB_REQUEST_FOCUS_IN_DESCENDANTS = 2;
  public static final int CB_ANIMATION_END = 3;
  public static final int CB_ANIMATION_START = 4;
  public static final int CB_ATTACHED_TO_WINDOW = 5;
  public static final int CB_CREATE_CONTEXT_MENU = 6;
  public static final int CB_CREATE_DRAWABLE_STATE = 7;
  public static final int CB_DETACHED_FROM_WINDOW = 8;
  public static final int CB_DRAW = 9;
  public static final int CB_FINISH_INFLATE = 10;
  public static final int CB_FOCUS_CHANGED = 11;
  public static final int CB_KEY_DOWN = 12;
  public static final int CB_KEY_MULTIPLE = 13;
  public static final int CB_KEY_SHORTCUT = 14;
  public static final int CB_KEY_UP = 15;
  public static final int CB_MEASURE = 16;
  public static final int CB_RESTORE_INSTANCE_STATE = 17;
  public static final int CB_SAVE_INSTANCE_STATE = 18;
  public static final int CB_SCROLL_CHANGED = 19;
  public static final int CB_SET_ALPHA = 20;
  public static final int CB_SIZE_CHANGED = 21;
  public static final int CB_TOUCH_EVENT = 22;
  public static final int CB_TRACKBALL_EVENT = 23;
  public static final int CB_WINDOW_FOCUS_CHANGED = 24;
  public static final int CB_WINDOW_VISIBILITY_CHANGED = 25;
  public static final int CB_CHECK_IS_TEXT_EDITOR = 26;
  public static final int CB_CREATE_INPUT_CONNECTION = 27;
  public static final int CB_FINISH_TEMPORARY_DETACH = 28;
  public static final int CB_KEY_PRE_IME = 29;
  public static final int CB_START_TEMPORARY_DETACH = 30;
  public static final int CB_KEY_LONG_PRESS = 31;
  public static final int CB_CONFIGURATION_CHANGED = 32;
  public static final int CB_DISPLAY_HINT = 33;
  public static final int CB_VISIBILITY_CHANGED = 34;
  private IRubyObject[] callbackProcs = new IRubyObject[35];
  ...
  public boolean onInterceptTouchEvent(android.view.MotionEvent ev) {
    if (callbackProcs[CB_INTERCEPT_TOUCH_EVENT] != null) {
      ...
      try {
        return (Boolean)RuntimeHelpers.invoke(getRuby().getCurrentContext(), callbackProcs[CB_INTERCEPT_TOUCH_EVENT], "call" , JavaUtil.convertJavaToRuby(getRuby(), ev)).toJava(boolean.class);
      } catch (RaiseException re) {
        re.printStackTrace();
        return false;
      }
  ...
  public boolean onRequestFocusInDescendants(int direction, android.graphics.Rect previouslyFocusedRect) {
    if (callbackProcs[CB_REQUEST_FOCUS_IN_DESCENDANTS] != null) {
      ...
      try {
        return (Boolean)RuntimeHelpers.invoke(getRuby().getCurrentContext(), callbackProcs[CB_REQUEST_FOCUS_IN_DESCENDANTS], "call" , JavaUtil.convertJavaToRuby(getRuby(), direction), JavaUtil.convertJavaToRuby(getRuby(), previouslyFocusedRect)).toJava(boolean.class);
      } catch (RaiseException re) {
        re.printStackTrace();
        return false;
      }
